...
export function buildAiPlugin(options: AiPluginOptions): AiPlugin {
  const aiPlugin: AiPlugin = {
    ...
    name_for_human: options.nameForHuman,
    name_for_model: options.nameForModel,
    description_for_human: options.descriptionForHuman,
    description_for_model: options.descriptionForModel,
